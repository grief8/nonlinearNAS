...
def get_nas_network(args, class_flag=False):
    if args.net == 'mobilenet':
        ...
        net = supermodel16
    elif args.net == 'searchsupermodel101':
        from models.supermodel import supermodel101
        net = supermodel101
    ...
    elif args.net == 'searchtinysupermodel50':
        from models.supermodel import tinysupermodel50
        net = tinysupermodel50

    elif args.net == 'searchmanumodel16':
        from models.manumodel import supermodel16
        net = supermodel16
    elif args.net == 'searchmanumodel50':
        from models.manumodel import supermodel50
        net = supermodel50
        ...
        net = cifarsupermodel22
    elif args.net == 'searchcifarmanumodel26':
        from models.manumodel import cifarsupermodel26
        net = cifarsupermodel26
    elif args.net == 'searchcifarmanumodel50':
        from models.manumodel import cifarsupermodel50
        net = cifarsupermodel50
    elif args.net == 'searchcifarmanumodel101':
        from models.manumodel import cifarsupermodel101
        net = cifarsupermodel101
